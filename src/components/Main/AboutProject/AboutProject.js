      ...
      <section className="project">
        ...
        <div className="project__container">
          ...
          <div className="project__deadlines">
            <h3 className="project__deadlines-header">На выполнение диплома ушло 5 недель</h3>
            <p className="project__deadlines-text">У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
          </div>
        </div>   
